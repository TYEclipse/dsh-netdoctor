 ...
 */
import { assertValidTarget, runProcess } from "./util.js";
/** Build the platform-specific argument array for the traceroute binary. */
export function traceArgs(host, maxHops, perHopTimeoutSec) {
...
export async function traceRoute(hostInput, maxHops, perHopTimeoutSec) {
    ...
    if (result.spawnError !== undefined) {
        throw new Error(process.platform === 'darwin' && result.spawnError.includes('not installed')
